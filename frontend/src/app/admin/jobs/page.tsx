  ...
  async function handleCreate() {
    try {
      await api("/jobs", {
        ...
        body: JSON.stringify({
          ...form,
          salaryMin: Number(form.salaryMin), // Конвертируем здесь
          salaryMax: Number(form.salaryMax), // Конвертируем здесь
        }),
      });
      setForm({
        enterpriseId: "",
        ...
        description: "",
        requirements: "",
        salaryMin: "", // Сброс в пустую строку
        salaryMax: "", // Сброс в пустую строку
        workConditions: "",
        location: "",
      });
      setShowForm(false);
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, salaryMin: e.target.value })} // Убрали Number()
                  placeholder="80000"
                  min="0"
                  className="w-full px-4 py-3 backdrop-blur-xl bg-white/60 border border-blue-200/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-gray-900"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, salaryMax: e.target.value })} // Убрали Number()
                  placeholder="150000"
                  min="0"
                  className="w-full px-4 py-3 backdrop-blur-xl bg-white/60 border border-blue-200/50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-gray-900"
                  required
